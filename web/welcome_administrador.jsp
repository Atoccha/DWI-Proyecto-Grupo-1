...
<body>   
    <%@ include file="INCLUDE/header_administrador.jsp" %>
        ...
        <section class="intro">
           <h2>¿Quienes Somos?</h2>
           <p>
              Somos una compañia que se encarga de brindar Servicios de Arquitectua con una amplia experiencia y compromiso en el desarrollo de diseños y proyectos exclusivos, funcionales y de alta calidad, logrando superar las expectativas de nuestros clientes, causando gran satisfacción.
           </p>
        </section>
